...
<div class="tab">
 ...
 <div class="tab">
  <h3> <i>III-information familiale :</i></h3><hr>
  <div class="container">
      <div class="row">
  <div class="col-md-6">
...
<div class="tab">
  ...
  <select class="sel" name="typecncc" id="exampleFormControlSelect1">
     ...
     <p><input placeholder="" class="" type="number" oninput="this.className = ''" name="date_de_create"></p>
      </div>
      </div>
      </div>
</div>
<div class="tab">
  <h3> <i>IV-information de bureau :</i></h3><hr>
  <div class="container">
      <div class="row">
