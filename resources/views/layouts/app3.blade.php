...
<head>
  ...
  <meta content="" name="keywords">
   <script src="{{ asset('jsa/app.js') }}" defer></script>
    <script src="{{ asset('jsa/cp.js') }}" defer></script>
    ...
    <!-- Styles -->
    <link href="{{ asset('cssa/app.css') }}" rel="stylesheet">
    <link href="{{ asset('cssa/cp.css') }}" rel="stylesheet">
