            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="icon" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <a class="dropdown-item" href="">{{$not->data['data']}}</a>                                                         
                                @endforeach
